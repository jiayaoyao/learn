...
// mode: 'history',
  routes: [
    ...
    },
    {
      ...
      iconCls: 'iconfont icon-users', // 图标样式class
      children: [
        {path: '/student/list', component: StudentList, name: '学生管理', menuShow: true}
      ]
    },
    {
      path: '/',
      ...
      iconCls: 'iconfont icon-users', // 图标样式class
      children: [
        {path: '/point/list', component: PointList, name: '知识点管理', menuShow: true}
      ]
    },
    {
      path: '/',
      ...
      iconCls: 'iconfont icon-users', // 图标样式class
      children: [
        {path: '/question/list', component: QuestionList, name: '问题管理', menuShow: true}
      ]
    },
    {
      path: '/',
