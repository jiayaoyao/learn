      ...
      <el-table :data="books" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
        ...
        <el-table-column type="expand">
          <template scope="props">
            <el-form>
              <el-form-item label="标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一标签一"></br>
                <el-checkbox-group >
        ...
        <el-table-column prop="point" label="考点" sortable></el-table-column>
        <el-table-column prop="lv" label="难易程度" sortable></el-table-column>
      ...
      <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
        <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
          ...
          <el-form-item label="知识点" prop="point">
            <el-select v-model="addForm.point" placeholder="请选择">
              <el-option
          ...
          <el-form-item label="难易程度" prop="lv">
            <el-select v-model="addForm.lv" placeholder="请选择">
              <el-option
                v-for="item in lvOptions"
                :key="item.value"
                :label="item.label"
          ...
          <el-form-item label="选择题" prop="title" v-show="addForm.type === '1'">
            <el-checkbox v-model="addForm.a_checked">A</el-checkbox>
            <el-input v-model="addForm.a_choice" auto-complete="off"></el-input>
            <el-checkbox v-model="addForm.b_checked">B</el-checkbox>
            <el-input v-model="addForm.b_choice" auto-complete="off"></el-input>
            <el-checkbox v-model="addForm.c_checked">C</el-checkbox>
            <el-input v-model="addForm.c_choice" auto-complete="off"></el-input>
            <el-checkbox v-model="addForm.d_checked">D</el-checkbox>
            <el-input v-model="addForm.d_choice" auto-complete="off"></el-input>
            <el-checkbox v-model="addForm.e_checked">E</el-checkbox>
            <el-input v-model="addForm.e_choice" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item inline label="简答题" prop="title" v-show="addForm.type === '2'">
            <el-input
              type="textarea"
